    ...
    <div class="container">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="price" name="price" value="<?php echo $post->price ?>">
            </div>
            <div class="mb-3">
                <label for="address" class="form-label">Địa chỉ</label>
                <input type="text" class="form-control" id="address" name="address"
                    value="<?php echo $post->address ?>">
            </div>
            <div class="mb-3">
                <label for="phone" class="form-label">Điện thoại</label>
                <input type="text" class="form-control" id="phone" name="phone" value="<?php echo $post->phone ?>">
            </div>
            <div class="mb-3">
                <label for="utilities" class="form-label">Tiện ích</label>
                <textarea class="form-control" id="utilities"
                    name="utilities"><?php echo $post->utilities ?></textarea>
            </div>
            <?php
            ...
            <div class="mb-3">
                ...
                <input type="text" name="images" id="images" class="form-control" value="<?php echo $post->images ?>"
                    hidden>
                <div class="card">
                    <div class="card-body">
                        <img id="images_img" src="<?php echo $post->images ?>" style="height: 300px; width: 300px;" />
